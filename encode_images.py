...
def main(src_dir,generated_images_dir,dlatent_dir ):
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?id=1QYkuXRREQNK9oG5-KbexZLyjX267PjIV', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('https://drive.google.com/uc?id=1QYkuXRREQNK9oG5-KbexZLyjX267PjIV', cache_dir=config.cache_dir) as f:
